        ...
        for (unsigned y = 0u; y < h; y++)
        {
            ...
            for (unsigned x = 0u; x < w; x += 8) {
                ...
                if (border >= 8) {
                    rs = v8f{
                        args.ImgA->Get_Red(i),
                            args.ImgA->Get_Red(i+1),
                            args.ImgA->Get_Red(i+2),
                            args.ImgA->Get_Red(i+3),
                            args.ImgA->Get_Red(i+4),
                            args.ImgA->Get_Red(i+5),
                            args.ImgA->Get_Red(i+6),
                            args.ImgA->Get_Red(i+7),
                    };
                    gs = v8f{
                        args.ImgA->Get_Green(i),
                            args.ImgA->Get_Green(i+1),
                            args.ImgA->Get_Green(i+2),
                            args.ImgA->Get_Green(i+3),
                            args.ImgA->Get_Green(i+4),
                            args.ImgA->Get_Green(i+5),
                            args.ImgA->Get_Green(i+6),
                            args.ImgA->Get_Green(i+7),
                    };
                    bs = v8f{
                        args.ImgA->Get_Blue(i),
                            args.ImgA->Get_Blue(i+1),
                            args.ImgA->Get_Blue(i+2),
                            args.ImgA->Get_Blue(i+3),
                            args.ImgA->Get_Blue(i+4),
                            args.ImgA->Get_Blue(i+5),
                            args.ImgA->Get_Blue(i+6),
                            args.ImgA->Get_Blue(i+7),
                    };
                } else {
                    rs = 11;
                    gs = 12;
                ...
                if (border >= 8) {
                    rs = v8f{
                        args.ImgB->Get_Red(i),
                            args.ImgB->Get_Red(i+1),
                            args.ImgB->Get_Red(i+2),
                            args.ImgB->Get_Red(i+3),
                            args.ImgB->Get_Red(i+4),
                            args.ImgB->Get_Red(i+5),
                            args.ImgB->Get_Red(i+6),
                            args.ImgB->Get_Red(i+7),
                    };
                    gs = v8f{
                        args.ImgB->Get_Green(i),
                            args.ImgB->Get_Green(i+1),
                            args.ImgB->Get_Green(i+2),
                            args.ImgB->Get_Green(i+3),
                            args.ImgB->Get_Green(i+4),
                            args.ImgB->Get_Green(i+5),
                            args.ImgB->Get_Green(i+6),
                            args.ImgB->Get_Green(i+7),
                    };
                    bs = v8f{
                        args.ImgB->Get_Blue(i),
                            args.ImgB->Get_Blue(i+1),
                            args.ImgB->Get_Blue(i+2),
                            args.ImgB->Get_Blue(i+3),
                            args.ImgB->Get_Blue(i+4),
                            args.ImgB->Get_Blue(i+5),
                            args.ImgB->Get_Blue(i+6),
                            args.ImgB->Get_Blue(i+7),
                    };
                } else {
                    rs = 11;
                    gs = 12;
